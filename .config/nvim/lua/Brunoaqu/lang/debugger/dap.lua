...
dap.adapters.cppdbg = {
    id = 'cppdbg',
    type = 'executable',
    command = '/home/bruno/.config/nvim/lua/Brunoaqu/lang/debugger/tools/vscode-cpptools/extension/debugAdapters/bin/OpenDebugAD7'
}

local cache = require 'Brunoaqu.lang.debugger.cache'
