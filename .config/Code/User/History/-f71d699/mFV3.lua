...
function M.init()
    ...
    keymap(n_v, 'gc', function()
        require('alex.keymaps.utils').cwd_current_buffer()
    end, default_settings)
    keymap(n_v, '<Leader>f', function()
        require('alex.keymaps.utils').toggle_tree()
    end, default_settings)
...
function M.lspsaga()
    ...
    keymap(n, '[e', function()
        require('alex.keymaps.utils').prev_diag()
    end, default_settings)
    keymap(n, ']e', function()
        require('alex.keymaps.utils').next_diag()
    end, default_settings)
    keymap(n, '[E', function()
        require('alex.keymaps.utils').prev_error()
    end, default_settings)
    keymap(n, ']E', function()
        require('alex.keymaps.utils').next_error()
    end, default_settings)
