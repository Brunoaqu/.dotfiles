...
export class ScanMapper {
  ...
  public static toDTO(scan: Scan) {
    return {
      ...
      reportSettings: {
        volumeFactor: scan.reportSettings.volumeFactor.value,
        diameterFactor: scan.reportSettings.diameterFactor.value,
      },
