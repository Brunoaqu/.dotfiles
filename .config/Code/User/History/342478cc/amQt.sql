SELECT Reports.reportId AS ID,
    ...
    Scans.area AS Area,
    Scans.avgFrameVolume AS VolumeMedioDoQuadro INTO OUTFILE '/exportdata/reports-dieres.txt' FIELDS TERMINATED BY ',' OPTIONALLY ENCLOSED BY '"' LINES TERMINATED BY '\n'
FROM Reports
