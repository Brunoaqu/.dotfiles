...
FROM Reports
    ...
    INNER JOIN Scans ON Reports.reportId = Scans.reportId INTO OUTFILE '/exportdata/reports-die.txt' FIELDS TERMINATED BY ',' OPTIONALLY ENCLOSED BY '"' LINES TERMINATED BY '\n';
