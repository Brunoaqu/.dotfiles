...
SELECT WoodLogsAux.reportId AS ID, Reports.counter AS Contador,
    WoodLogs.Diametro AS Diametro INTO OUTFILE '/export_data/relatorios-dieres-diametros.csv' FIELDS TERMINATED BY ',' OPTIONALLY ENCLOSED BY '"' LINES TERMINATED BY '\n'
FROM WoodLogsAux
