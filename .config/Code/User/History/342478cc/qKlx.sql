...
SELECT WoodLogsAux.reportId AS ID, WoodLogs.Diametro AS Diametro INTO OUTFILE '/export_data/relatorios-dieres-diametros.csv' FIELDS TERMINATED BY ',' OPTIONALLY ENCLOSED BY '"' LINES TERMINATED BY '\n'
