    ...
    return {
      ...
      logs: await this.knex('WoodLogs')
        ...
        .select([
          ...
          'WoodLogs.woodLogName AS log_name',
          'WoodLogs.confiability AS confiability',
          'WoodLogs.height AS height',
          'WoodLogs.width AS width',
          'WoodLogs.positionX AS position_x',
          'WoodLogs.positionY AS position_y',
          'WoodLogs.reportId AS reportId',
        ]),
    };
  }
