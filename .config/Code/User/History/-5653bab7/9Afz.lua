...
}, -- Language/Tools/LSP/Comp
{
    ...
    event = {'User NvimStartupDone'},
    config = function()
        require 'Brunoaqu.lang.debugger'
    end
}, {
    'folke/trouble.nvim',
    dependencies = {'nvim-tree/nvim-web-devicons'},
    cmd = {'TroubleToggle'},
    config = function()
        require 'Brunoaqu.lang.lsp.trouble'
    end
}, {
    'mfussenegger/nvim-lint',
    event = {'User NvimStartupDone'},
    config = function()
        require 'Brunoaqu.lang.linter'
    end
}, {
    ...
    build = {':TSUpdate'},
    config = function()
        require 'Brunoaqu.lang.treesitter'
    end
}, {
    'neovim/nvim-lspconfig',
    config = function()
        require 'Brunoaqu.lang.lsp'
    end,
    -- event = { 'User NvimStartupDone' },
    ...
    dependencies = {{
        'folke/neodev.nvim',
        config = function()
            require 'Brunoaqu.lang.tools.neodev'
        end
    }, {
        'williamboman/mason.nvim',
        build = ':MasonUpdate',
        config = function()
            require 'Brunoaqu.lang.mason'
        end
    }}
}, {
    ...
    event = {'User NvimStartupDone'},
    config = function()
        require 'Brunoaqu.lang.lsp.lspsaga'
    end
}, {
    'hrsh7th/nvim-cmp',
    event = {'User NvimStartupDone'},
    config = function()
        require 'Brunoaqu.lang.completion'
    end,
    ...
    event = {'User NvimStartupDone'},
    config = function()
        require 'Brunoaqu.lang.lsp.signature'
    end
}, -- Compatibility/Support/Language tools
{
    ...
    ft = {'tex', 'latex'},
    config = function()
        require 'Brunoaqu.lang.tools.latex'
    end
} -- Editing/Modal
, {
